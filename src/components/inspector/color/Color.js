		...
		<>
			...
			<div className={lutsSlider ? "none" : ""}>
				...
				<Row className={classNames("row-slider")} style={{"marginBottom": "9px"}}>
					<InputLabel className={sld1 ? "active" : ""} onDoubleClick={()=>resetSlider1()}>Intensity</InputLabel>
					<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld7 ? "active" : ""} onDoubleClick={()=>resetSlider7()}>Temperature</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld8 ? "active" : ""} onDoubleClick={()=>resetSlider8()}>Tint</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld9 ? "active" : ""} onDoubleClick={()=>resetSlider9()}>Contrast</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld10 ? "active" : ""} onDoubleClick={()=>resetSlider10()}>Pivot</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld11 ? "active" : ""} onDoubleClick={()=>resetSlider11()}>Midtone Detail</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld12 ? "active" : ""} onDoubleClick={()=>resetSlider12()}>Color Boost</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld13 ? "active" : ""} onDoubleClick={()=>resetSlider13()}>Shadows</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld14 ? "active" : ""} onDoubleClick={()=>resetSlider14()}>Highlights</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld15 ? "active" : ""} onDoubleClick={()=>resetSlider15()}>Saturation</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "3px"}}>
				<InputLabel className={sld16 ? "active" : ""} onDoubleClick={()=>resetSlider16()}>Hue</InputLabel>
				<RcSlider>
			...
			<Row className={classNames("row-slider")} style={{"marginBottom": "19px"}}>
				<InputLabel className={sld17 ? "active" : ""} onDoubleClick={()=>resetSlider17()}>Lum Mix</InputLabel>
				<RcSlider>
